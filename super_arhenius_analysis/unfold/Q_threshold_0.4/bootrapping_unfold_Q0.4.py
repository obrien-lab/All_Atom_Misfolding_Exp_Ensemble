...
"""
Disentanglement time where Q<=Q_threshold for 1ns
Data for 2ww4-disentanglement
"""
Q_threshold = 0.4
FPT_550 = np.array(
    [5.67, 8.97, 2.19, 6.69, 7.8, 8.52, 3.75, 8.31, 8.41, 5.33, 2.33, 2.64, 14.57, 6.72, 11.36, 4.14, 4.16, 4.11, 6.21,
     10.19, 6.09, 6.85, 4.03, 2.42, 4.86, 7.47, 5.29, 9.11, 5.98, 10.26, 4.2, 3.87, 2.25, 3.8, 6.86, 6.46, 6.68, 5.2,
     4.93, 2.89, 4.34, 6.26, 3.95, 18.87, 8.6, 3.63, 9.46, 5.81, 6.44, 2.98])
FPT_600 = np.array(
    [1.22, 0.95, 2.31, 1.65, 1.02, 1.64, 2.09, 3.68, 1.42, 1.08, 1.93, 1.62, 1.57, 2.2, 1.96, 2.0, 2.6, 2.06, 3.36,
     1.67, 1.32, 1.78, 1.69, 1.1, 2.94, 0.84, 3.5, 0.77, 1.4, 2.77, 1.12, 3.11, 0.2, 1.43, 1.72, 1.1, 0.78, 0.97, 1.16,
     0.49, 1.39, 1.81, 2.08, 3.77, 0.63, 0.76, 1.34, 1.91, 0.97, 1.11])
FPT_650 = np.array(
    [1.21, 0.46, 0.87, 0.28, 0.53, 0.46, 0.24, 0.94, 0.8, 0.36, 0.63, 1.63, 0.31, 1.03, 0.45, 0.66, 0.49, 0.62, 0.76,
     1.03, 0.6, 0.74, 0.86, 1.55, 0.99, 0.78, 0.42, 0.45, 0.37, 0.87, 0.55, 0.76, 0.54, 0.27, 1.43, 0.43, 0.46, 1.22,
     0.54, 0.94, 0.27, 0.99, 1.18, 0.24, 0.64, 0.89, 0.83, 0.99, 0.58, 0.35])
FPT_700 = np.array(
    [0.39, 0.28, 0.33, 0.2, 0.57, 0.38, 0.36, 0.17, 0.38, 0.23, 0.32, 0.3, 0.37, 0.33, 0.19, 0.27, 0.5, 0.24, 0.54,
     0.17, 0.43, 0.54, 0.19, 0.28, 0.44, 0.39, 0.52, 0.37, 0.25, 0.25, 0.14, 0.32, 0.21, 0.33, 0.37, 0.21, 0.17, 0.24,
     0.52, 0.11, 0.27, 0.33, 0.35, 0.18, 0.24, 0.17, 0.26, 0.23, 0.21, 0.2])
FPT_750 = np.array(
    [0.28, 0.16, 0.09, 0.16, 0.31, 0.22, 0.28, 0.15, 0.17, 0.26, 0.26, 0.21, 0.37, 0.17, 0.29, 0.11, 0.16, 0.18, 0.28,
     0.18, 0.26, 0.21, 0.12, 0.12, 0.19, 0.29, 0.09, 0.21, 0.27, 0.19, 0.23, 0.26, 0.12, 0.19, 0.13, 0.2, 0.2, 0.16,
     0.21, 0.27, 0.22, 0.23, 0.23, 0.17, 0.15, 0.21, 0.16, 0.24, 0.27, 0.24])
FPT_800 = np.array(
    [0.17, 0.08, 0.15, 0.13, 0.09, 0.07, 0.09, 0.11, 0.13, 0.08, 0.15, 0.15, 0.17, 0.23, 0.18, 0.1, 0.17, 0.11, 0.22,
     0.09, 0.05, 0.16, 0.21, 0.1, 0.12, 0.09, 0.15, 0.09, 0.11, 0.11, 0.15, 0.19, 0.09, 0.11, 0.21, 0.14, 0.13, 0.1,
     0.07, 0.1, 0.08, 0.1, 0.18, 0.14, 0.14, 0.13, 0.14, 0.19, 0.07, 0.17])
